...
function ENT:InitializeSystems()
    ...
    self:LoadSystem("Electric","81_541_3k_Electric")
    ...
    self:LoadSystem("Panel","81_714kkl_Panel")
    ...
    -- self:LoadSystem("ScreenInfo","81_screens")

    -- self:LoadSystem("ScreenInfo","81_screen_kiev")
end
