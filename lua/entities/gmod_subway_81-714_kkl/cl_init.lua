...
for i = 0,12 do
    ...
    ENT.ClientProps["lamp1_"..i+1] = {
        ...
        pos = Vector(394.5-66.2*i, i>4 and 0 or i>10 and -0.5 or 0.5, 67.608),
        ang = Angle(0,0,0),
...
ENT.ClientProps["lamps2"] = {
    model = "models/metrostroi_train/81-717/monitor_int_interim.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,0,0),
    nohide=true
}
...
ENT.ClientProps["salon"] = {
    model = "models/metrostroi_train/81-717/salon_714_otl.mdl",
    pos = Vector(0,0,-1),
    ang = Angle(0,-90,0),
    hide=2,
}
...
ENT.ClientProps["otsek_1"] = {  -- ЕКСТРЕНИЙ ЗВ'ЯЗОК З МАШИНІСТОМ
	model = "models/metrostroi_train/81-717/otsek/otsek_1.mdl",
	pos = Vector(0,0,-2),
    ang = Angle(0,-90,0),
    scale=1,
}
...
function ENT:Initialize()
    ...
    self.Monitor = self:CreateRT("Monitor",1056,1056)
...
function ENT:Think()
    ...
    for i = 1,13 do
        ...
        self:ShowHide("lamp1_4",false)
        self:ShowHide("lamp1_10",false)
    ...
    local vb = self:GetPackedBool("VB")
...
function ENT:Draw()
    ...
    if IsValid(self.ClientEnts["lamps2"]) then
        self.ClientEnts["lamps2"]:SetSubMaterial(2,"!MetrostroiRT2")
