...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("ALS_BARS_BLPM")
...
function TRAIN_SYSTEM:Think(dT)
    ...
    Train.BLPM_1R1:TriggerInput("Set",S["F1"])
    Train.BLPM_1R2:TriggerInput("Set",S["F1"])
    Train.BLPM_1R3:TriggerInput("Set",(1-Train.BLPM_1R1.Value)*(1-Train.BLPM_1R2.Value))

    Train.BLPM_2R1:TriggerInput("Set",S["F2"])
    Train.BLPM_2R2:TriggerInput("Set",S["F2"])
    Train.BLPM_2R3:TriggerInput("Set",(1-Train.BLPM_2R1.Value)*(1-Train.BLPM_2R2.Value))

    Train.BLPM_3R1:TriggerInput("Set",S["F3"])
    Train.BLPM_3R2:TriggerInput("Set",S["F3"])
    Train.BLPM_3R3:TriggerInput("Set",(1-Train.BLPM_3R1.Value)*(1-Train.BLPM_3R2.Value))

    Train.BLPM_4R1:TriggerInput("Set",S["F4"])
    Train.BLPM_4R2:TriggerInput("Set",S["F4"])
    Train.BLPM_4R3:TriggerInput("Set",(1-Train.BLPM_4R1.Value)*(1-Train.BLPM_4R2.Value))

    Train.BLPM_5R1:TriggerInput("Set",S["F5"])
    Train.BLPM_5R2:TriggerInput("Set",S["F5"])
    Train.BLPM_5R3:TriggerInput("Set",(1-Train.BLPM_5R1.Value)*(1-Train.BLPM_5R2.Value))

    if Train.PD1 then
        Train.BLPM_6R1:TriggerInput("Set",S["F6"]*Train.PD1.Value)
        Train.BLPM_6R2:TriggerInput("Set",S["F6"]*Train.PD2.Value)
        Train.BLPM_6R3:TriggerInput("Set",(1-Train.BLPM_6R1.Value)*(1-Train.BLPM_6R2.Value))
    else
        Train.BLPM_6R1:TriggerInput("Set",S["F6"])
        Train.BLPM_6R2:TriggerInput("Set",S["F6"])
        Train.BLPM_6R3:TriggerInput("Set",(1-Train.BLPM_6R1.Value)*(1-Train.BLPM_6R2.Value))
    end
