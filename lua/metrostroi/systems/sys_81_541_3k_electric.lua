...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_541_3k_Electric")
TRAIN_SYSTEM.MVM = 1
...
function TRAIN_SYSTEM:SolveAllInternalCircuits(Train,dT,firstIter)
    ...
    --Вспом цепи приём
    Panel.EmergencyLights = T[49]*Train.A49.Value
...
local wires = {10,1,6,3,20,4,5,2,48,8,39,19,25,13,-13,14,24,17,71,36,-28,37,49,16,12,31,32,69,27,23,22,23,37,59,60,58,61,556}
