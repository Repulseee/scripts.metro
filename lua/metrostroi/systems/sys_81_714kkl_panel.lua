...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_714kkl_Panel")
...
function TRAIN_SYSTEM:Initialize()
    ...
    for i=1,4 do  
        self.Train:LoadSystem("Pred"..i.."C","Relay","VA21-29",{normally_closed=false})
    end 
    --Вагонные
    ...
    self.Train:LoadSystem("KO1","Relay","Switch",{bass=true})
     ...
     self.Train:LoadSystem("KVP1","Relay","Switch",{bass=true,open_time=2.3})
     self.Train:LoadSystem("RR1","Relay","Switch",{bass=true})
...
TRAIN_SYSTEM.AVMap = {
    ...
    "AV3","AV4","AV5","A81","AV6","A80","Pred1C","Pred2C","Pred3C","Pred4C",
}