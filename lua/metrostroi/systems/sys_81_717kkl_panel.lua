...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_717kkl_Panel")
...
function TRAIN_SYSTEM:Initialize()
    ...
    self.Train:LoadSystem("EPKOn","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KVTOn","Relay","Switch", {bass = true})
    self.Train:LoadSystem("BARSLockSwitch","Relay","Switch",{maxvalue=2,defaultvalue=1,bass=true})
    self.Train:LoadSystem("ALSToggleSwitch","Relay","Switch",{maxvalue=2,defaultvalue=1,bass=true})
    self.Train:LoadSystem("MehBV","Relay","Switch", {bass = true})
    self.Train:LoadSystem("VozvratRP","Relay","Switch", {bass = true})
    self.Train:LoadSystem("Vent1Cab","Relay","Switch", {bass = true})
    ...
    self.Train:LoadSystem("EPK1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RO1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("NG1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("FMM11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("GE1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KSR11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("ROT11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KRO1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KK1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("VDOL1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("VDOP1","Relay","Switch", {bass = true})
    
    self.Train:LoadSystem("VDZ1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RV21","Relay","Switch", {bass = true})
    self.Train:LoadSystem("R1_51","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RVT1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("K251","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RV11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("LK11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("LK22","Relay","Switch", {bass = true})
    self.Train:LoadSystem("SR11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("VN","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RD1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RKR1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RVZ11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("VZ11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KO1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KO111","Relay","Switch", {bass = true,open_time=3})
    self.Train:LoadSystem("PM1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("PS1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("PT1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("BUM_PTR2","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KVC1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("U22","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RPVozvrat1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("VUD11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("BPSN1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("MK1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("LK1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KSN1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("OtklBV1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("LK31","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RezMK1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KDL1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KDP1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("ARS1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("VUS1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("ALS1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("A311","Relay","Switch", {bass = true})
    self.Train:LoadSystem("A321","Relay","Switch", {bass = true})
    self.Train:LoadSystem("A481","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KVT1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("LK41","Relay","Switch", {bass = true})
    self.Train:LoadSystem("LK51","Relay","Switch", {bass = true})
    self.Train:LoadSystem("KVP1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("TR11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RSU1","Relay","Switch", {bass = true}) 
    self.Train:LoadSystem("RUVD1","Relay","Switch", {bass = true}) 
    self.Train:LoadSystem("OhrSig","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RVT11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("RPB1","Relay","Switch", {bass = true})
    self.Train:LoadSystem("SIR55","Relay","Switch", {bass = true})
    -- self.Train:LoadSystem("SR11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("BR11","Relay","Switch", {bass = true})
    self.Train:LoadSystem("ROT22","Relay","Switch", {bass = true})
    self.Train:LoadSystem("AVOSV","Relay","Switch", {bass = true})
    ...
    self.Train:LoadSystem("RPU2","Relay","Switch", {bass = true})
    for i=1,6 do  
        self.Train:LoadSystem("Pred"..i.."C","Relay","VA21-29")
    end 
